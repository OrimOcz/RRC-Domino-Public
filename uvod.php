...
<title>Špatná stránka</title>
    <style>
		...
		*{
		...
		html::before{
			background-image: url("../data/photos/dsc_6431.jpg");
...
<body>
	<h1>Jejda něco se <span>pokazilo</span></h1>
    <div class="loader-line"></div>
	<h2>Omlouváme se za klompikace, ale stránka na kterou se snažíte dostat již není dostupná. Jedná se o pozůstatek starého webu.</h2>
	<a href="/"><i class="fas fa-angle-left"></i> přejít na nový web</a>
</body>
</html>
