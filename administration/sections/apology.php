	...
	<div class="data">
		<table id="table">
			<tr>
				...
				<th>Od /Do</th>
				<th>Místo</th>
				<th>Kdo - Důvod neúčasti na tréninku</th>
			</tr>
			<?php
			...
			if($records == false  || empty($records)){
				...
				foreach($records as $row){
					...
					$users =  SelectAttendanceTrening($row['Traning_ID'], 2);
					...
					<tr>
						...
						<td><?php
							...
							{
								echo $user['User_FirstName'] .' '.$user['User_LastName'].' - '.$user['Attendance_Reason'].'<br>';
